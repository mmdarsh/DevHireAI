          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label htmlFor="resume-upload" className="cursor-pointer">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">PDF, PNG, JPG files only, up to 10MB</p>
                    </div>
                  </div>
                </label>
              </div>
            ...
            <div className="flex gap-4 pt-6">
              <button
                ...
                onClick={onClose}
                disabled={isUploading}
                className="flex-1 px-4 py-3 border border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isUploading ? (
                  <>
